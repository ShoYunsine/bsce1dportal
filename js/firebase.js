...
// This forces the account chooser to only allow your school’s domain
provider.setCustomParameters({
    hd: "bicol-u.edu.ph"   // hosted domain restriction
});
...
export async function loginWithGoogle() {
    signInWithPopup(auth, provider)
        .then(async (result) => {
            ...
            // At this point, it’s guaranteed to be a @bicol-u.edu.ph account
